...
test -z "${PHPCS_IGNORE}" && PHPCS_IGNORE=$INPUT_PHPCS_IGNORE
...
test -z "${PHPCS_IGNORE}" && PHPCS_IGNORE=

echo "PHPCS report: ${PHPCS_REPORT}"
echo "PHPCS standard: ${PHPCS_STANDARD}"
echo "PHPCS severity: ${PHPCS_SEVERITY}"
echo "PHPCS extentions: ${PHPCS_EXTENSIONS}"
echo "PHPCS ignore: ${PHPCS_IGNORE}"
